...
const Skills: React.FC = () => {
  ...
  const technicalSkills = [
    { name: 'Web Designing (UI/UX)', icon: Palette, level: 85, color: 'bg-blue-500' },
    { name: 'HTML & CSS', icon: Globe, level: 100, color: 'bg-orange-500' },
    { name: 'JavaScript / TypeScript', icon: Code, level: 70, color: 'bg-yellow-500' },
    { name: 'React & Tailwind CSS', icon: Rocket, level: 90, color: 'bg-cyan-500' },
    ...
    { name: 'Hosting (Vercel / Netlify)', icon: Cloud, level: 100, color: 'bg-indigo-500' },
    { name: 'VS Code & Dev Tools', icon: Code, level: 90, color: 'bg-blue-600' },
    { name: 'Dialogflow Chatbot Design', icon: Bot, level: 100, color: 'bg-green-500' },
    ...
    <section id="skills" className="py-20 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          Combining technical skills, creative vision, and effective communication to build impactful digital products from start to finish.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <span className="px-3 py-1 bg-violet-100 dark:bg-violet-900 text-violet-800 dark:text-violet-200 rounded-full text-sm font-medium">
              Conversational AI
            </span>
            ...
            <span className="px-3 py-1 bg-rose-100 dark:bg-rose-900 text-rose-800 dark:text-rose-200 rounded-full text-sm font-medium">
              AI Automation
            </span>
          </div>
