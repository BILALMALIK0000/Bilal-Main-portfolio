  ...
  const projects = [
    {
      ...
      description:
        'A custom food ordering platform developed for KababsJES using modern web technologies. Includes a dynamic product catalog, responsive UI, and WhatsApp API integration for instant order placement—bridging traditional food service with digital efficiency.',
      image:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mt-6 max-w-3xl mx-auto">
           Explore a selection of my recent projects, highlighting practical expertise in modern web development and intelligent AI-powered chatbot solutions.
          </p>
        </motion.div>
