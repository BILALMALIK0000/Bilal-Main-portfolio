...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 dark:from-gray-950 dark:via-blue-950 dark:to-gray-950"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <TypingAnimation
             texts={[
             'High-Performance Websites for Growing Businesses',
             'AI Chatbots That Work 24/7 for Your Customers',
             'Smart Digital Solutions — Tailored for You',
          ...
          className="font-medium"
            ...
            >
            I design and develop high-performance websites and AI-powered solutions that help businesses grow. My focus is on blending cutting-edge technology with smooth, user-friendly experiences.
            </motion.p>
            ...
            >
              <div className="w-80 h-80 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 p-2">
                <div className="w-full h-full rounded-full bg-gray-300 dark:bg-gray-700 flex items-center justify-center overflow-hidden">
                  <img
                    src="https://scontent.fkhi28-1.fna.fbcdn.net/v/t39.30808-6/528378752_1307619277601406_6319026643683457073_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeGFO8-st9WIpUZp4CBgYDm1OH26WJQUzB04fbpYlBTMHaJ2Eg0HqyLMG2T23tDuPObgUua2Tw3d6I76o7WM5a00&_nc_ohc=g-0VThfdaL8Q7kNvwH_mktL&_nc_oc=AdkLIaCTy7U2wKgB_OU5evpSqBh4v4_8sGu-EDhicmIT54h7oNw2z197xm-d0W62XzM&_nc_zt=23&_nc_ht=scontent.fkhi28-1.fna&_nc_gid=IXl3ICRwoVA0D-1Rxuv8QQ&oh=00_AfXV_2h0QDh2JlbPzc1FsmniwQ0Hn-FD79CZn1TJFcEbVw&oe=68A1EE9F"
                    alt="Muhammad Bilal Malik"
