...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "fd898624-5a15-426a-8ebc-e0afefb0cacf", // <-- yahan apna Web3Forms key dalna
          name: formData.name,
  ...
  const contactInfo = [
    { icon: Mail, label: 'Email', value: 'bilalmalik0938@gmail.com', href: 'bilalmalik0938@gmail.com', color: 'text-red-500' },
    { icon: Phone, label: 'Phone', value: '0310-6990938', href: 'tel:0310-6990938', color: 'text-green-500' },
    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 mt-6 max-w-3xl mx-auto">
         Have a project, idea, or just want to chat about tech? I’m always open to new opportunities and conversations. Feel free to reach out — I’d be happy to connect!
         </p>
